...
{
[EventScript(66082)]
public class ManSea200 : QuestScript
{
    ...
    switch( quest.Sequence )
    {
      ...
      case 0:
      {
        if( param1 == 1002694 ) // ACTOR0 = MERLWYB
        {
          if( quest.UI8AL != 1 )
          {
            Scene00000(); // Scene00000: Normal(Talk, QuestOffer, TargetCanMove), id=MERLWYB
      ...
      case 2:
      {
        if( param1 == 1002695 ) // ACTOR3 = LNOPHLO
        {
          if( quest.UI8AL != 1 )
          {
            Scene00004(); // Scene00004: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LNOPHLO
          }
          break;
        }
      ...
      case 3:
      {
        ...
        if( param1 == 1002695 ) // ACTOR3 = LNOPHLO
        {
          Scene00009(); // Scene00009: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LNOPHLO
          break;
        }
        if( param1 == 2001675 ) // EOBJECT0 = unknown
        {
      ...
      case 4:
      {
        if( param1 == 1002830 ) // ACTOR4 = SERPENT
        {
          if( quest.UI8AL != 1 )
          {
            Scene00011(); // Scene00011: Normal(Talk, TargetCanMove), id=SERPENT
          }
          break;
        }
        if( param1 == 1000109 || param1 == 4296108319 || param1 == 1141023) // ACTOR5 = CABINCREW
        {
        ...
        if( param1 == 1002695 ) // ACTOR3 = LNOPHLO
        {
          Scene00014(); // Scene00014: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LNOPHLO
      ...
      case 5:
      {
        ...
        if( param1 == 1002830 ) // ACTOR4 = SERPENT
        {
          Scene00020(); // Scene00020: Normal(Talk, TargetCanMove), id=SERPENT
          break;
        }
        if( param1 == 2001678 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 1002695 ) // ACTOR3 = LNOPHLO
        {
          Scene00022(); // Scene00022: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LNOPHLO
      ...
      case 6:
      {
        if( param1 == 1000106 ) // ACTOR7 = LIONNELLAIS
        {
          if( quest.UI8AL != 1 )
          {
            Scene00024(); // Scene00024: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LIONNELLAIS
          }
          break;
        }
        if( param1 == 2001678 ) // EOBJECT2 = unknown
        ...
        if( param1 == 1002695 ) // ACTOR3 = LNOPHLO
        {
          Scene00026(); // Scene00026: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LNOPHLO
      ...
      case 7:
      {
        ...
        if( param1 == 1000106 ) // ACTOR7 = LIONNELLAIS
        {
          Scene00031(); // Scene00031: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LIONNELLAIS
          break;
        }
        if( param1 == 2001678 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 1002695 ) // ACTOR3 = LNOPHLO
        {
          Scene00033(); // Scene00033: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LNOPHLO
      ...
      case 8:
      {
        ...
        if( param1 == 1002695 ) // ACTOR3 = LNOPHLO
        {
          Scene00038(); // Scene00038: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LNOPHLO
          // +Callback Scene00039: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown
          break;
        }
        if( param1 == 1000106 ) // ACTOR7 = LIONNELLAIS
        {
          Scene00040(); // Scene00040: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LIONNELLAIS
      ...
      case 255:
      {
        ...
        if( param1 == 1002695 ) // ACTOR3 = LNOPHLO
        {
          Scene00049(); // Scene00049: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LNOPHLO
          // +Callback Scene00050: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown
          break;
        }
        if( param1 == 1000106 ) // ACTOR7 = LIONNELLAIS
        {
          Scene00051(); // Scene00051: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=LIONNELLAIS
...
private void Scene00006() //SEQ_2: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00006: Empty(None), id=unknown" );
    checkProgressSeq2();
  }
...
private void Scene00008() //SEQ_3: EOBJECT1, UI8AL = 1, Flag8(1)=True(Todo:2)
  {
    ...
    var callback = (SceneResult result) =>
    {
      ...
      checkProgressSeq3();
      player.Event.StopEvent(Id);
      //player.TeleportTo(new WorldPosition(132,new Vector3(7.8f, -21.97f, 123.88f), 1.58f));
...
private void Scene00010() //SEQ_3: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00010: Empty(None), id=unknown" );
    checkProgressSeq3();
  }
...
private void Scene00012() //SEQ_4: ACTOR5, <No Var>, <No Flag>
  {
    ...
    var callback = (SceneResult result) =>
    {
      ...
      {
        player.Event.StopEvent(Id);
        player.TeleportTo(new WorldPosition(132,new Vector3(35.5f, -19f, 105f), -3.14f));
      }
    };
...
private void Scene00013() //SEQ_4: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00013: Empty(None), id=unknown" );
    checkProgressSeq4();
  }
...
private void Scene00015() //SEQ_4: ACTOR3, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00015: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown" );
    var callback = (SceneResult result) =>
    {
      player.Event.StopEvent(Id);
      //player.TeleportTo(new WorldPosition(132,new Vector3(7.8f, -21.97f, 123.88f), 1.58f));
...
private void Scene00021() //SEQ_5: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00021: Empty(None), id=unknown" );
    checkProgressSeq5();
  }
...
private void Scene00023() //SEQ_5: ACTOR3, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00023: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown" );
    var callback = (SceneResult result) =>
    {
...
private void Scene00025() //SEQ_6: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00025: Empty(None), id=unknown" );
    checkProgressSeq6();
  }
...
private void Scene00027() //SEQ_6: ACTOR3, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00027: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown" );
    var callback = (SceneResult result) =>
    {
      player.sendDebug("Finished with AutoFadeIn scene, reloading zone..." );
      player.Event.StopEvent(Id);
...
private void Scene00032() //SEQ_7: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00032: Empty(None), id=unknown" );
    checkProgressSeq7();
  }
...
private void Scene00034() //SEQ_7: ACTOR3, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00034: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown" );
    var callback = (SceneResult result) =>
    {
      player.sendDebug("Finished with AutoFadeIn scene, reloading zone..." );
      player.Event.StopEvent(Id);
...
private void Scene00037() //SEQ_8: EOBJECT4, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00037: Empty(None), id=unknown" );
    checkProgressSeq8();
  }
...
private void Scene00039() //SEQ_8: ACTOR3, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00039: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown" );
    var callback = (SceneResult result) =>
    {
      player.sendDebug("Finished with AutoFadeIn scene, reloading zone..." );
      player.Event.StopEvent(Id);
...
private void Scene00041() //SEQ_8: ACTOR7, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00041: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown" );
    var callback = (SceneResult result) =>
    {
      player.Event.StopEvent(Id);
      //player.TeleportTo(new WorldPosition(130,new Vector3(-44.14f, 84f, -0.47f), 1.3f));
...
private void Scene00048() //SEQ_255: EOBJECT4, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00048: Empty(None), id=unknown" );
  }
...
private void Scene00050() //SEQ_255: ACTOR3, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00050: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown" );
    var callback = (SceneResult result) =>
    {
      player.sendDebug("Finished with AutoFadeIn scene, reloading zone..." );
      player.Event.StopEvent(Id);
...
private void Scene00052() //SEQ_255: ACTOR7, <No Var>, <No Flag>
  {
    player.sendDebug("ManSea200:66082 calling Scene00052: Normal(CutScene, AutoFadeIn, ReturnTrue), id=unknown" );
    var callback = (SceneResult result) =>
    {
      player.sendDebug("Finished with AutoFadeIn scene, reloading zone..." );
      player.Event.StopEvent(Id);
