...
{
[EventScript(65644)]
public class ManSea002 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        ...
        if( param1 == 1000926 ) // ACTOR2 = BLAUTHOTA
        {
          if( quest.UI8AL != 1 )
          {
            Scene00006(); // Scene00006: Normal(Talk, TargetCanMove), id=BLAUTHOTA
          }
          break;
        }
        break;
...
private void Scene00000() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("ManSea002:65644 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("ManSea002:65644 calling Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove, SystemTalk, ENpcBind), id=BADERON" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00002() //SEQ_1: AETHERYTE0, UI8BL = 1, Flag8(1)=True
  {
    player.sendDebug("ManSea002:65644 calling Scene00002: Normal(None), id=unknown" );
    var callback = (SceneResult result) =>
    {
      Scene00003();
    };
...
private void Scene00003() //SEQ_1: AETHERYTE0, UI8BL = 1, Flag8(1)=True
  {
    player.sendDebug("ManSea002:65644 calling Scene00003: Normal(Talk, FadeIn, SystemTalk), id=unknown" );
    var callback = (SceneResult result) =>
    {
      quest.UI8BL =  (byte)( 1);
...
private void Scene00004() //SEQ_1: ACTOR1, UI8BH = 1, Flag8(2)=True
  {
    player.sendDebug("ManSea002:65644 calling Scene00004: NpcTrade(Talk, TargetCanMove), id=SWOZBLAET" );
    var callback = (SceneResult result) =>
    {
      if( result.numOfResults > 0 && result.GetResult( 0 ) == 1 )
      {
...
private void Scene00005() //SEQ_1: ACTOR1, UI8BH = 1, Flag8(2)=True
  {
    player.sendDebug("ManSea002:65644 calling Scene00005: Normal(Talk, FadeIn, TargetCanMove), id=SWOZBLAET" );
    var callback = (SceneResult result) =>
    {
      quest.UI8BH =  (byte)( 1);
...
private void Scene00006() //SEQ_1: ACTOR2, UI8AL = 1, Flag8(3)=True
  {
    player.sendDebug("ManSea002:65644 calling Scene00006: Normal(Talk, TargetCanMove), id=BLAUTHOTA" );
    var callback = (SceneResult result) =>
    {
      quest.UI8AL =  (byte)( 1);
...
private void Scene00007() //SEQ_255: , <No Var>, <No Flag>
  {
    player.sendDebug("ManSea002:65644 calling Scene00007: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=BADERON" );
    var callback = (SceneResult result) =>
    {
      if( result.numOfResults > 0 && result.GetResult( 0 ) == 1 )
      {
