...
{
[EventScript(66415)]
public class GaiUsb510 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        ...
        if( param1 == 4296835 ) // ENEMY0 = unknown
        {
        // empty entry
          break;
        }
        if( param1 == 4296837 ) // ENEMY1 = unknown
        {
        // empty entry
          break;
        }
        if( param1 == 2002321 ) // EOBJECT0 = unknown
        {
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00007(); // Scene00007: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=FUANDREC
        break;
      }
      default:
      {
...
private void Scene00006() //SEQ_1: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb510:66415 calling Scene00006: Empty(None), id=unknown" );
    checkProgressSeq1();
  }
