...
{
[EventScript(66473)]
public class GaiUsb914 : QuestScript
{
...
private void Scene00000() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb914:66473 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb914:66473 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=CID" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00002() //SEQ_255: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb914:66473 calling Scene00002: NpcTrade(Talk, TargetCanMove), id=unknown" );
    var callback = (SceneResult result) =>
    {
      if( result.numOfResults > 0 && result.GetResult( 0 ) == 1 )
      {
...
private void Scene00003() //SEQ_255: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb914:66473 calling Scene00003: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=CID" );
    var callback = (SceneResult result) =>
    {
      if( result.numOfResults > 0 && result.GetResult( 0 ) == 1 )
      {
