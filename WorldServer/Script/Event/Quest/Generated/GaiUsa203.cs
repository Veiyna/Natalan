...
{
[EventScript(66262)]
public class GaiUsa203 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 5:
      {
        ...
        {
          Scene00012(); // Scene00012: Normal(Talk, TargetCanMove), id=NPCB
          break;
        }
        break;
      }
      ...
      case 255:
      {
        ...
        {
          Scene00013(); // Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=BUSCARRON
          break;
        }
        if( param1 == 1002935 ) // ACTOR2 = NPCB
        {
          Scene00014(); // Scene00014: Normal(Talk, TargetCanMove), id=NPCB
          break;
        }
        break;
      }
...
private void Scene00002() //SEQ_1: , <No Var>, <No Flag>(Todo:0)
  {
    player.sendDebug("GaiUsa203:66262 calling Scene00002: Empty(None), id=unknown" );
...
private void Scene00003() //SEQ_2: , <No Var>, <No Flag>(Todo:1)
  {
    player.sendDebug("GaiUsa203:66262 calling Scene00003: Empty(None), id=unknown" );
...
private void Scene00005() //SEQ_3: , <No Var>, <No Flag>(Todo:2)
  {
    player.sendDebug("GaiUsa203:66262 calling Scene00005: Empty(None), id=unknown" );
...
private void Scene00007() //SEQ_4: , <No Var>, <No Flag>(Todo:3)
  {
    player.sendDebug("GaiUsa203:66262 calling Scene00007: Empty(None), id=unknown" );
    player.SendQuestMessage(Id, 3, 0, 0, 0 );
    checkProgressSeq4();
  }

private void Scene00008() //SEQ_5: ACTOR1, UI8AL = 1, Flag8(1)=True(Todo:4)
  {
    player.sendDebug("GaiUsa203:66262 calling Scene00008: Empty(None), id=unknown" );
    Scene00010();
  }
private void Scene00010() //SEQ_5: ACTOR1, UI8AL = 1, Flag8(1)=True(Todo:4)
  {
...
private void Scene00011() //SEQ_5: ACTOR1, UI8AL = 1, Flag8(1)=True(Todo:4)
  {
...
private void Scene00012() //SEQ_5: ACTOR2, <No Var>, <No Flag>
  {
