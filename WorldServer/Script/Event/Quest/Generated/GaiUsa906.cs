...
{
[EventScript(66337)]
public class GaiUsa906 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 4:
      {
        ...
        // +Callback Scene00005: Normal(Talk, TargetCanMove), id=URSANDEL
        break;
      }
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00006(); // Scene00006: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=MINFILIA
        break;
      }
      default:
      {
...
private void Scene00002() //SEQ_1: , <No Var>, <No Flag>(Todo:0)
  {
    player.sendDebug("GaiUsa906:66337 calling Scene00002: Empty(None), id=unknown" );
    var callback = (SceneResult result) =>
    {
...
private void Scene00003() //SEQ_3: , <No Var>, <No Flag>(Todo:2)
  {
    player.sendDebug("GaiUsa906:66337 calling Scene00003: Normal(None), id=unknown" );
    var callback = (SceneResult result) =>
    {
      player.SendQuestMessage(Id, 2, 0, 0, 0 );
      player.SetDutyUnlock(6);
      checkProgressSeq3();
    };
