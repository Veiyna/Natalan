...
{
[EventScript(66297)]
public class GaiUsa509 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 1006702 ) // ACTOR1 = OSRIC
        {
          if( quest.UI8AL != 1 )
          {
        ...
        if( param1 == 1006703 ) // ACTOR2 = YAYAZUKE
        {
          if( quest.UI8BH != 1 )
          {
        ...
        if( param1 == 1006704 ) // ACTOR3 = ANGRYRIVER
        {
          if( quest.UI8BL != 1 )
          {
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00008(); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=GISILBEHRT
        break;
      }
      default:
      {
