...
{
[EventScript(66314)]
public class GaiUsa705 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 1006228 ) // ACTOR1 = WILRED
        {
          if( !quest.getBitFlag8( 1 ) )
          {
            Scene00002(); // Scene00002: Normal(Talk, Message, PopBNpc, TargetCanMove), id=WILRED
          }
          break;
        }
        // BNpcHack credit moved to ACTOR1
        if( param1 == 4279871 ) // ENEMY0 = unknown
        {
        // empty entry
          break;
        }
        if( param1 == 4279874 ) // ENEMY1 = unknown
        {
        // empty entry
          break;
        }
      ...
      case 2:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00003(); // Scene00003: Normal(Talk, NpcDespawn, TargetCanMove), id=WILRED
        break;
      }
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00004(); // Scene00004: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=GUNDOBALD
        break;
      }
      default:
      {
