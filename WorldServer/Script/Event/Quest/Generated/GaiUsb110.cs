...
{
[EventScript(66365)]
public class GaiUsb110 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == /*UNKNOWN*/1 ) // ENEMY0 or A3_40 == A0_37.ENEMY1 or A3_40 == A0_37.ENEMY2 = unknown
        {
          if( quest.UI8AL != 3 )
          {
        ...
        if( param1 == 1006736 ) // ACTOR1 = UKAHZUNA
        {
          Scene00002(); // Scene00002: Normal(Talk, TargetCanMove), id=UKAHZUNA
          break;
        }
        break;
      }
      case 2:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00003(); // Scene00003: Normal(Talk, TargetCanMove), id=UKAHZUNA
        // +Callback Scene00004: Normal(Talk, NpcDespawn, TargetCanMove), id=UKAHZUNA
        break;
      }
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00006(); // Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=UTYKHATIA
        break;
      }
      default:
      {
