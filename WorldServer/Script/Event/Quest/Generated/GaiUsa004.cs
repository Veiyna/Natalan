...
{
[EventScript(66246)]
public class GaiUsa004 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00002(); // Scene00002: Normal(Talk, TargetCanMove), id=ROSA
        break;
      }
      ...
      case 2:
      {
        if( param1 == 2001902 ) // EOBJECT0 = unknown
        {
          if( quest.UI8AL != 1 )
          {
            Scene00003(); // Scene00003: Normal(Inventory), id=unknown
          }
          break;
        }
        // BNpcHack credit moved to EOBJECT0
        if( param1 == 4277224 ) // ENEMY0 = unknown
        {
      ...
      case 255:
      {
        ...
        // +Callback Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=ROLFE
        break;
      }
      default:
      {
...
private void Scene00000() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa004:66246 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
...
private void Scene00002() //SEQ_1: , <No Var>, <No Flag>(Todo:0)
  {
    player.sendDebug("GaiUsa004:66246 calling Scene00002: Normal(Talk, TargetCanMove), id=ROSA" );
    var callback = (SceneResult result) =>
    {
...
private void Scene00003() //SEQ_2: EOBJECT0, UI8AL = 1, Flag8(1)=True(Todo:1)
  {
    player.sendDebug("GaiUsa004:66246 calling Scene00003: Normal(Inventory), id=unknown" );
    var callback = (SceneResult result) =>
    {
      quest.UI8AL =  (byte)( 1);
...
private void Scene00005() //SEQ_255: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa004:66246 calling Scene00005: NpcTrade(Talk, TargetCanMove), id=unknown" );
    var callback = (SceneResult result) =>
    {
      if( result.numOfResults > 0 && result.GetResult( 0 ) == 1 )
      {
