...
{
[EventScript(66322)]
public class GaiUsa802 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 2001982 ) // EOBJECT0 = unknown
        {
          if( quest.UI8AL != 1 )
          {
        ...
        if( param1 == 4285321 ) // ENEMY0 = unknown
        {
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00004(); // Scene00004: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=IVAURAULT
        break;
      }
      default:
      {
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa802:66322 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=IVAURAULT" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00002() //SEQ_1: EOBJECT0, UI8AL = 1, Flag8(1)=True(Todo:0)
  {
    player.sendDebug("GaiUsa802:66322 calling Scene00002: Empty(None), id=unknown" );
    quest.UI8AL =  (byte)( 1);
...
private void Scene00003() //SEQ_1: ENEMY0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa802:66322 calling Scene00003: Normal(Message, PopBNpc), id=unknown" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq1();
    };
