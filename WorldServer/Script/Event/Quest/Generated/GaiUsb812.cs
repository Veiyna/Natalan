...
{
[EventScript(66457)]
public class GaiUsb812 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 255:
      {
        if( param1 == 1007818 ) // ACTOR1 = NORMAN
        {
          Scene00004(); // Scene00004: Normal(Talk, Message, QuestReward, QuestComplete, TargetCanMove), id=NORMAN
          break;
        }
        if( param1 == 2001019 ) // EOBJECT0 = unknown
        {
...
private void Scene00003() //SEQ_1: , <No Var>, <No Flag>(Todo:0)
  {
    player.sendDebug("GaiUsb812:66457 calling Scene00003: Empty(None), id=unknown" );
...
private void Scene00006() //SEQ_255: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb812:66457 calling Scene00006: Empty(None), id=unknown" );
  }
};
}
