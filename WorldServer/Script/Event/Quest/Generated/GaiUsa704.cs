...
{
[EventScript(66313)]
public class GaiUsa704 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 1006221 ) // ACTOR1 = WALDHAR
        {
          if( quest.UI8AL != 1 )
          {
            Scene00002(); // Scene00002: Normal(Talk, TargetCanMove), id=WALDHAR
          }
          break;
        }
        if( param1 == 1006222 ) // ACTOR2 = ADALIND
        {
          if( quest.UI8BH != 1 )
          {
            Scene00003(); // Scene00003: Normal(Talk, TargetCanMove), id=ADALIND
          }
          break;
        }
        if( param1 == 1006223 ) // ACTOR3 = SIFRID
        {
          if( quest.UI8BL != 1 )
          {
            Scene00004(); // Scene00004: Normal(Talk, TargetCanMove), id=SIFRID
          }
          break;
        }
        if( param1 == 1006224 ) // ACTOR4 = TALEBOT
        {
          if( quest.UI8CH != 1 )
          {
            Scene00005(); // Scene00005: Normal(Talk, TargetCanMove), id=TALEBOT
          }
          break;
        }
        break;
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00006(); // Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=GUNDOBALD
        break;
      }
      default:
      {
...
private void Scene00005() //SEQ_1: ACTOR4, UI8CH = 1, Flag8(4)=True
  {
