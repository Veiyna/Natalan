...
{
[EventScript(66296)]
public class GaiUsa508 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00002(); // Scene00002: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=ANNABEL
        break;
      }
      default:
      {
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa508:66296 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=ANNABEL" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
