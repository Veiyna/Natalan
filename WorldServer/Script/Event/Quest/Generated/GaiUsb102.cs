...
{
[EventScript(66357)]
public class GaiUsb102 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 2:
      {
        if( param1 == 2002045 ) // EOBJECT1 = unknown
        {
          if( quest.UI8AL != 1 )
          {
        ...
        if( param1 == 4293187 ) // ENEMY0 = unknown
        {
          Scene00006(); // Scene00006: Empty(None), id=unknown
          break;
        }
        if( param1 == 2002044 ) // EOBJECT0 = unknown
        {
...
private void Scene00000() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00000: Normal(QuestOffer, TargetCanMove, SystemTalk, CanCancel), id=unknown" );
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=UODHNUN" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00002() //SEQ_1: , <No Var>, <No Flag>(Todo:0)
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00002: Normal(Inventory), id=unknown" );
    owner.Event.NewScene( Id, 2, SceneFlags.HIDE_HOTBAR);
  }
private void Scene00003() //SEQ_1: , <No Var>, <No Flag>(Todo:0)
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00003: Empty(None), id=unknown" );
...
private void Scene00005() //SEQ_2: EOBJECT1, UI8AL = 1, Flag8(1)=True(Todo:1)
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00005: Normal(Message, PopBNpc), id=unknown" );
    var callback = (SceneResult result) =>
    {
      quest.UI8AL =  (byte)( 1);
...
private void Scene00006() //SEQ_2: ENEMY0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00006: Empty(None), id=unknown" );
    checkProgressSeq2();
  }

private void Scene00007() //SEQ_2: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00007: Empty(None), id=unknown" );
    checkProgressSeq2();
  }

private void Scene00008() //SEQ_255: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00008: NpcTrade(Talk, TargetCanMove), id=unknown" );
    var callback = (SceneResult result) =>
    {
      if( result.numOfResults > 0 && result.GetResult( 0 ) == 1 )
      {
...
private void Scene00009() //SEQ_255: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb102:66357 calling Scene00009: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=UODHNUN" );
    var callback = (SceneResult result) =>
    {
      if( result.numOfResults > 0 && result.GetResult( 0 ) == 1 )
      {
