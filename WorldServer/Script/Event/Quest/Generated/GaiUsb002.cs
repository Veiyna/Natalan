...
{
[EventScript(66345)]
public class GaiUsb002 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 2002033 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4291274 ) // ENEMY0 = unknown
        {
        // empty entry
          break;
        }
        if( param1 == 4291279 ) // ENEMY1 = unknown
        {
        // empty entry
          break;
        }
        if( param1 == 4291283 ) // ENEMY2 = unknown
        {
        // empty entry
          break;
        }
        if( param1 == 4291284 ) // ENEMY3 = unknown
        {
        // empty entry
          break;
        }
        if( param1 == 4291285 ) // ENEMY4 = unknown
        {
        // empty entry
          break;
        }
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00004(); // Scene00004: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=TRACHTOUM
        break;
      }
      default:
      {
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb002:66345 calling Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove), id=TRACHTOUM" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00003() //SEQ_1: EOBJECT0, UI8AL = 5, Flag8(1)=True(Todo:0)
  {
    player.sendDebug("GaiUsb002:66345 calling Scene00003: Normal(Message, PopBNpc), id=unknown" );
    var callback = (SceneResult result) =>
    {
      quest.UI8AL =  (byte)( 5);
