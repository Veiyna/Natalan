...
{
[EventScript(66433)]
public class GaiUsb702 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 1006395 ) // ACTOR1 = NINNE
        {
          if( quest.UI8AL != 1 )
          {
            Scene00002(); // Scene00002: Normal(Talk, TargetCanMove), id=NINNE
          }
          break;
        }
        if( param1 == 1006396 ) // ACTOR2 = CRAVELLIN
        {
          if( quest.UI8BH != 1 )
          {
            Scene00003(); // Scene00003: Normal(Talk, TargetCanMove), id=CRAVELLIN
          }
          break;
        }
        if( param1 == 1006377 ) // ACTOR3 = FORLEMORT
        {
          if( quest.UI8BL != 1 )
          {
            Scene00004(); // Scene00004: Normal(Talk, TargetCanMove), id=FORLEMORT
          }
          break;
        }
        break;
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00005(); // Scene00005: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=HAURCHEFANT
        break;
      }
      default:
      {
