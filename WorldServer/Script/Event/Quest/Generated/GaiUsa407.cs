...
{
[EventScript(66285)]
public class GaiUsa407 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 2001960 || param1 == 0xF000000000000000/*Ground aoe hack enabled*/ ) // EOBJECT0 = unknown
        {
          if( quest.UI8AL != 1 )
          {
        ...
        if( param1 == 2001961 || param1 == 0xF000000000000000/*Ground aoe hack enabled*/ ) // EOBJECT1 = unknown
        {
          if( quest.UI8BH != 1 )
          {
        ...
        if( param1 == 2001962 || param1 == 0xF000000000000000/*Ground aoe hack enabled*/ ) // EOBJECT2 = unknown
        {
          if( quest.UI8BL != 1 )
          {
        ...
        if( param1 == 2001963 || param1 == 0xF000000000000000/*Ground aoe hack enabled*/ ) // EOBJECT3 = unknown
        {
          if( quest.UI8CH != 1 )
          {
      ...
      case 255:
      {
        if( param1 == 1006207 ) // ACTOR0 = CLAUDIEN
        {
          Scene00010(); // Scene00010: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=CLAUDIEN
          break;
        }
        if( param1 == 2001960 ) // EOBJECT0 = unknown
        {
          Scene00012(); // Scene00012: Empty(None), id=unknown
          break;
        }
        if( param1 == 2001961 ) // EOBJECT1 = unknown
        {
          Scene00014(); // Scene00014: Empty(None), id=unknown
          break;
        }
        if( param1 == 2001962 ) // EOBJECT2 = unknown
        {
          Scene00016(); // Scene00016: Empty(None), id=unknown
          break;
        }
        if( param1 == 2001963 ) // EOBJECT3 = unknown
        {
...
private void Scene00003() //SEQ_1: EOBJECT0, UI8AL = 1, Flag8(1)=True(Todo:0)
  {
    player.sendDebug("GaiUsa407:66285 calling Scene00003: Empty(None), id=unknown" );
    quest.UI8AL =  (byte)( 1);
...
private void Scene00005() //SEQ_1: EOBJECT1, UI8BH = 1, Flag8(2)=True
  {
    player.sendDebug("GaiUsa407:66285 calling Scene00005: Empty(None), id=unknown" );
    quest.UI8BH =  (byte)( 1);
...
private void Scene00007() //SEQ_1: EOBJECT2, UI8BL = 1, Flag8(3)=True
  {
    player.sendDebug("GaiUsa407:66285 calling Scene00007: Empty(None), id=unknown" );
    quest.UI8BL =  (byte)( 1);
    quest.setBitFlag8( 3, true );
    checkProgressSeq1();
  }

private void Scene00008() //SEQ_1: EOBJECT3, UI8CH = 1, Flag8(4)=True
  {
...
private void Scene00009() //SEQ_1: EOBJECT3, UI8CH = 1, Flag8(4)=True
  {
    player.sendDebug("GaiUsa407:66285 calling Scene00009: Empty(None), id=unknown" );
    quest.UI8CH =  (byte)( 1);
...
private void Scene00012() //SEQ_255: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa407:66285 calling Scene00012: Empty(None), id=unknown" );
  }

private void Scene00014() //SEQ_255: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa407:66285 calling Scene00014: Empty(None), id=unknown" );
  }

private void Scene00016() //SEQ_255: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa407:66285 calling Scene00016: Empty(None), id=unknown" );
  }

private void Scene00018() //SEQ_255: EOBJECT3, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa407:66285 calling Scene00018: Empty(None), id=unknown" );
  }
};
}
