...
{
[EventScript(66355)]
public class GaiUsb012 : QuestScript
{
...
private void Scene00004() //SEQ_1: ENEMY0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb012:66355 calling Scene00004: Empty(None), id=unknown" );
    checkProgressSeq1();
  }

private void Scene00006() //SEQ_1: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb012:66355 calling Scene00006: Empty(None), id=unknown" );
    checkProgressSeq1();
  }

private void Scene00008() //SEQ_2: EOBJECT2, UI8AL = 1, Flag8(1)=True(Todo:1)
  {
    player.sendDebug("GaiUsb012:66355 calling Scene00008: Empty(None), id=unknown" );
    quest.UI8AL =  (byte)( 1);
    quest.setBitFlag8( 1, true );
...
private void Scene00009() //SEQ_2: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb012:66355 calling Scene00009: Empty(None), id=unknown" );
    checkProgressSeq2();
  }
