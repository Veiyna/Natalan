...
{
[EventScript(66332)]
public class GaiUsa901 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 1006253 ) // ACTOR1 = LAUGHINGFURY
        {
          if( quest.UI8AL != 1 )
          {
        ...
        if( param1 == 1006254 ) // ACTOR2 = VAVAPU
        {
          if( quest.UI8BH != 1 )
          {
        ...
        if( param1 == 1006258 ) // ACTOR3 = ADEMAR
        {
          if( quest.UI8BL != 1 )
          {
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00008(); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=AELUUIN
        break;
      }
      default:
      {
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa901:66332 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=AELUUIN" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00003() //SEQ_1: ACTOR1, UI8AL = 1, Flag8(1)=True(Todo:0)
  {
    player.sendDebug("GaiUsa901:66332 calling Scene00003: Normal(Talk, TargetCanMove), id=LAUGHINGFURY" );
    var callback = (SceneResult result) =>
    {
      quest.UI8AL =  (byte)( 1);
...
private void Scene00005() //SEQ_1: ACTOR2, UI8BH = 1, Flag8(2)=True
  {
    player.sendDebug("GaiUsa901:66332 calling Scene00005: Normal(Talk, TargetCanMove), id=VAVAPU" );
    var callback = (SceneResult result) =>
    {
      quest.UI8BH =  (byte)( 1);
...
private void Scene00007() //SEQ_1: ACTOR3, UI8BL = 1, Flag8(3)=True
  {
    player.sendDebug("GaiUsa901:66332 calling Scene00007: Normal(Talk, TargetCanMove), id=ADEMAR" );
    var callback = (SceneResult result) =>
    {
      quest.UI8BL =  (byte)( 1);
