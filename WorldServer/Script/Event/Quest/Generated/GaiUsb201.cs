...
{
[EventScript(66368)]
public class GaiUsb201 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00002(); // Scene00002: Normal(Talk, TargetCanMove), id=OZUNNAZUN
        break;
      }
      case 2:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00003(); // Scene00003: Normal(Talk, TargetCanMove), id=BRAYFLOX
        break;
      }
      case 3:
      {
        if( param1 == 1006268 ) // ACTOR2 = BRAYFLOX
        {
          Scene00004(); // Scene00004: Normal(Talk, TargetCanMove), id=BRAYFLOX
          break;
        }
        break;
      }
      ...
      case 4:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00005(); // Scene00005: Normal(Talk, FadeIn, TargetCanMove), id=BRAYFLOX
        break;
      }
...
private void Scene00003() //SEQ_2: , <No Var>, <No Flag>(Todo:1)
  {
    player.sendDebug("GaiUsb201:66368 calling Scene00003: Normal(Talk, TargetCanMove), id=BRAYFLOX" );
    var callback = (SceneResult result) =>
    {
      player.SetDutyUnlock(8);
...
private void Scene00004() //SEQ_3: ACTOR2, <No Var>, <No Flag>(Todo:2)
  {
