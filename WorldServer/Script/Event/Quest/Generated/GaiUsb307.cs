...
{
[EventScript(66384)]
public class GaiUsb307 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 2002059 ) // EOBJECT0 = unknown
        {
          if( quest.UI8AL != 1 )
          {
        ...
        if( param1 == 2002060 ) // EOBJECT1 = unknown
        {
          if( quest.UI8BH != 1 )
          {
        ...
        if( param1 == 2002061 ) // EOBJECT2 = unknown
        {
          if( quest.UI8BL != 1 )
          {
...
private void Scene00000() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb307:66384 calling Scene00000: Normal(QuestOffer, TargetCanMove, SystemTalk, CanCancel), id=unknown" );
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb307:66384 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=DREST" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00003() //SEQ_1: EOBJECT0, UI8AL = 1, Flag8(1)=True(Todo:0)
  {
    player.sendDebug("GaiUsb307:66384 calling Scene00003: Empty(None), id=unknown" );
    quest.UI8AL =  (byte)( 1);
...
private void Scene00005() //SEQ_1: EOBJECT1, UI8BH = 1, Flag8(2)=True
  {
    player.sendDebug("GaiUsb307:66384 calling Scene00005: Empty(None), id=unknown" );
    quest.UI8BH =  (byte)( 1);
...
private void Scene00007() //SEQ_1: EOBJECT2, UI8BL = 1, Flag8(3)=True
  {
    player.sendDebug("GaiUsb307:66384 calling Scene00007: Empty(None), id=unknown" );
    quest.UI8BL =  (byte)( 1);
...
private void Scene00009() //SEQ_255: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb307:66384 calling Scene00009: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=SHAMANILOHMANI" );
    var callback = (SceneResult result) =>
    {
      if( result.numOfResults > 0 && result.GetResult( 0 ) == 1 )
      {
