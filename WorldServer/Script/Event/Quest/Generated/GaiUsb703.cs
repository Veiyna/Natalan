...
{
[EventScript(66434)]
public class GaiUsb703 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00002(); // Scene00002: Normal(Talk, TargetCanMove), id=NOBLEDAUGHTER
        break;
      }
      case 2:
      {
        if( param1 == 1006399 ) // ACTOR2 = HERETIC
        {
          if( quest.UI8AL != 1 )
          {
            Scene00003(); // Scene00003: Normal(Talk, NpcDespawn, TargetCanMove), id=HERETIC
          }
          break;
        }
        if( param1 == 1006398 ) // ACTOR1 = NOBLEDAUGHTER
        {
          Scene00004(); // Scene00004: Normal(Talk, TargetCanMove), id=NOBLEDAUGHTER
          break;
        }
        break;
      }
      ...
      case 3:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00006(); // Scene00006: Empty(None), id=unknown
        break;
      }
...
private void Scene00006() //SEQ_3: , <No Var>, <No Flag>(Todo:2)
  {
    player.sendDebug("GaiUsb703:66434 calling Scene00006: Empty(None), id=unknown" );
