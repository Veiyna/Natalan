...
{
[EventScript(66329)]
public class GaiUsa809 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 4286922 ) // EVENTRANGE0 = unknown
        {
          if( quest.UI8AL != 1 )
          {
        ...
        if( param1 == 4286954 ) // ENEMY0 = unknown
        {
        // empty entry
          break;
        }
        if( param1 == 1006249 ) // ACTOR1 = ADVENTURE
        {
          Scene00003(); // Scene00003: Normal(Talk, TargetCanMove), id=ADVENTURE
          break;
        }
        if( param1 == 2002461 ) // EOBJECT0 = unknown
        {
          Scene00004(); // Scene00004: Empty(None), id=unknown
          break;
        }
        if( param1 == 1006250 ) // ACTOR2 = unknown
        {
      ...
      case 2:
      {
        if( param1 == 1006249 ) // ACTOR1 = ADVENTURE
        {
          if( quest.UI8AL != 1 )
          {
            Scene00006(); // Scene00006: Normal(Talk, TargetCanMove), id=ADVENTURE
          }
          break;
        }
        if( param1 == 1006250 ) // ACTOR2 = unknown
      ...
      case 255:
      {
        if( param1 == 1002804 ) // ACTOR0 = AELUUIN
        {
          Scene00008(); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=AELUUIN
          break;
        }
        if( param1 == 1006249 ) // ACTOR1 = ADVENTURE
        {
          Scene00009(); // Scene00009: Normal(Talk, TargetCanMove), id=ADVENTURE
          break;
        }
        if( param1 == 1006250 ) // ACTOR2 = unknown
        {
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa809:66329 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=AELUUIN" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00002() //SEQ_1: EVENTRANGE0, UI8AL = 1, Flag8(1)=True(Todo:0)
  {
...
private void Scene00003() //SEQ_1: ACTOR1, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa809:66329 calling Scene00003: Normal(Talk, TargetCanMove), id=ADVENTURE" );
    var callback = (SceneResult result) =>
    {
    };
...
private void Scene00004() //SEQ_1: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa809:66329 calling Scene00004: Empty(None), id=unknown" );
    checkProgressSeq1();
  }

private void Scene00005() //SEQ_1: ACTOR2, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa809:66329 calling Scene00005: Empty(None), id=unknown" );
  }
...
private void Scene00007() //SEQ_2: ACTOR2, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa809:66329 calling Scene00007: Empty(None), id=unknown" );
  }
...
private void Scene00010() //SEQ_255: ACTOR2, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsa809:66329 calling Scene00010: Empty(None), id=unknown" );
  }
};
}
