...
{
[EventScript(66462)]
public class GaiUsb903 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      ...
      case 1:
      {
        if( param1 == 4293212 ) // EVENTRANGE0 = unknown
        {
          Scene00002(); // Scene00002: Normal(Message, PopBNpc), id=unknown
          break;
        }
        if( param1 == 2002157 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4293210 ) // ENEMY0 = unknown
        {
          Scene00004(); // Scene00004: Empty(None), id=unknown
          break;
        }
        if( param1 == 4293211 ) // ENEMY1 = unknown
        {
          Scene00005(); // Scene00005: Empty(None), id=unknown
          break;
        }
        if( param1 == 2002513 ) // EOBJECT1 = unknown
        {
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00009(); // Scene00009: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=NIVIE
        break;
      }
      default:
      {
...
private void Scene00001() //SEQ_0: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb903:66462 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=NIVIE" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq0();
    };
...
private void Scene00003() //SEQ_1: EOBJECT0, UI8AL = 2, Flag8(1)=True
  {
...
private void Scene00004() //SEQ_1: ENEMY0, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb903:66462 calling Scene00004: Empty(None), id=unknown" );
    checkProgressSeq1();
  }

private void Scene00005() //SEQ_1: ENEMY1, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb903:66462 calling Scene00005: Empty(None), id=unknown" );
    checkProgressSeq1();
  }

private void Scene00006() //SEQ_1: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb903:66462 calling Scene00006: Empty(None), id=unknown" );
    checkProgressSeq1();
  }
...
private void Scene00008() //SEQ_2: , <No Var>, <No Flag>
  {
    player.sendDebug("GaiUsb903:66462 calling Scene00008: Normal(Talk, TargetCanMove), id=DRILLEMONT" );
    var callback = (SceneResult result) =>
    {
      checkProgressSeq2();
    };
