...
{
[EventScript(65692)]
public class SubFst050 : QuestScript
{
  ...
  void onProgress(uint type, ulong param1, ulong param2, ulong param3 )
  {
    switch( quest.Sequence )
    {
      case 0:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00000(); // Scene00000: Normal(Talk, QuestOffer, QuestAccept, TargetCanMove), id=KEITHA
        break;
      }
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00001(); // Scene00001: NpcTrade(Talk, TargetCanMove), id=KEITHA
