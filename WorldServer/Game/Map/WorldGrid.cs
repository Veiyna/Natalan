...
namespace WorldServer.Game.Map
{
    public class WorldGrid
    {
        ...
        private readonly Dictionary<Vector2G, WorldCell> cells = new();
        ...
        public void Search(SearchCheck check, List<Vector2G> tranversedCells, List<Actor> intersectedActors)
        {
