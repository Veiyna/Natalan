...
namespace WorldServer.Game.Social
{
    ...
    {
        private static readonly Dictionary<SocialType, QueuedCounter<uint>> socialCounters = new();
        private static readonly Dictionary<ulong, SocialBase> socialEntities = new();
