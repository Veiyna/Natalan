...
namespace WorldServer.Network.Handler
{
    ...
    {
        [SubPacketHandler(SubPacketClientHandlerId.ClientInventoryAction, SubPacketHandlerFlags.RequiresWorld)]
        public static void HandleClientInventoryAction(WorldSession session, ClientInventoryAction inventoryAction)
        {
            session.Send(new ServerInventoryAction
            {
                Sequence = inventoryAction.Sequence,
                Type = inventoryAction.Action
            });
