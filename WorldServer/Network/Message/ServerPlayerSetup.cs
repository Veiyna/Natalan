...
namespace WorldServer.Network.Message
{
    ...
    public class ServerPlayerSetup : SubPacket
    {
        ...
        public override void Write(BinaryWriter writer)
        {
            ...
            writer.Write(this.Character.Progression.Mount.ToArray()); // two more bytes for dawntrail?

            var ornamentMask = new BitArray(8 * 8, false);
            ...
            var testMask = new BitArray(23 * 8, false);
