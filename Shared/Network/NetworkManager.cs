...
namespace Shared.Network
{
    public static class NetworkManager
    {
        ...
        private static readonly HashSet<Session> sessions = [];
        private static readonly ReaderWriterLockSlim mutex = new();

        private static readonly ConcurrentQueue<(Connection connection, ConnectionChannel channel)> pendingAdd = new();
        private static readonly ConcurrentQueue<Session> pendingRemove = new();
        ...
        public static HashSet<Session> GetSessions()
        {
            return sessions;
        }
